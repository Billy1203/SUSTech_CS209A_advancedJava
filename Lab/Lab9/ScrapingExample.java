...
public class ScrapingExample {
	...
	private static String[] winnerDates(String wikiPage) throws IOException {
		String[] dates = new String[2];
		dates[0] = "";
		dates[1] = "";
		Document doc = Jsoup.connect("https://en.wikipedia.org" + wikiPage).get();
	...
	public static void main(String[] args) throws IOException {
		String[] dates;
		Document doc = Jsoup.connect("https://en.wikipedia.org/wiki/Turing_Award").get();
